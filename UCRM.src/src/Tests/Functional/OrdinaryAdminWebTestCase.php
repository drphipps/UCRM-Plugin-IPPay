...
abstract class OrdinaryAdminWebTestCase extends UcrmWebTestCase
{
    /**
     * @var Client
     */
    ...
    public static function beforeClass()
    {
        ...
        $server = [
            'PHP_AUTH_PW' => getenv('UCRM_ADMIN_USERNAME') ?: User::USER_ORDINARY_ADMIN,
            'PHP_AUTH_USER' => getenv('UCRM_ADMIN_PASSWORD') ?: 'ordinary_admin',
        ];
