...
class DeleteInvoiceConsumer extends AbstractConsumer
{
    /**
     * @var InvoiceFacade
     */
    ...
    {
        return DeleteInvoiceMessage::class;
    }
    ...
    public function executeBody(array $data): int
    {
        ...
        $this->invoiceFacade->handleDelete($invoice);

        $this->logger->info(sprintf('Invoice %d deleted.', $data['invoiceId']));
