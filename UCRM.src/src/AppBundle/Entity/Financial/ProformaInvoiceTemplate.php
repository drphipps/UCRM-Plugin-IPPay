...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\ProformaInvoiceTemplateRepository")
 * @ORM\Table(
 *     indexes={
 ...
 * )
 */
class ProformaInvoiceTemplate implements LoggableInterface, ParentLoggableInterface, SoftDeleteLoggableInterface, FinancialTemplateInterface
{
    ...
    {
        $message['logMsg'] = [
            'message' => 'Proforma invoice template %s deleted',
    ...
    {
        $message['logMsg'] = [
            'message' => 'Proforma invoice template %s added',
            'replacements' => $this->getName(),
        ];
    ...
    {
        $message['logMsg'] = [
            'message' => 'Proforma invoice template %s archived',
            'replacements' => $this->getName(),
        ];
    ...
    {
        $message['logMsg'] = [
            'message' => 'Proforma invoice template %s restored',
            'replacements' => $this->getName(),
        ];
