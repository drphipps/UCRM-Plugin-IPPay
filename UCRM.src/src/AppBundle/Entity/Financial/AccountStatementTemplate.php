...
/**
 * @ORM\Entity(repositoryClass="AppBundle\Repository\AccountStatementTemplateRepository")
 * @ORM\Table(
 *     indexes={
 ...
 * )
 */
class AccountStatementTemplate implements LoggableInterface, ParentLoggableInterface, SoftDeleteLoggableInterface, FinancialTemplateInterface
{
    ...
    {
        $message['logMsg'] = [
            'message' => 'Account statement template %s deleted',
    ...
    {
        $message['logMsg'] = [
            'message' => 'Account statement template %s added',
            'replacements' => $this->getName(),
        ];
    ...
    {
        $message['logMsg'] = [
            'message' => 'Account statement template %s archived',
            'replacements' => $this->getName(),
        ];
    ...
    {
        $message['logMsg'] = [
            'message' => 'Account statement template %s restored',
            'replacements' => $this->getName(),
        ];
